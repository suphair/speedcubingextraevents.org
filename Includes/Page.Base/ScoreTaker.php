...
<?php if($notAttempts){ ?>
    <form method="POST" action="<?= PageAction('ScoreTaker.DeclineAll')?>"  onsubmit="return confirm('Attention: Confirm the completion of the discipline.')">
