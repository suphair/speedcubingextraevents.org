...
<?php } ?>
    ...
    if ($err) {
        ?>
                        ...
                        <?php if ($Competitor) { ?>        
                            ...
                            if (isset($competitorevent_row['Command_ID'])) {
    ...
    if ($CompetitionEvent['Discipline_CodeScript'] == 'team_cup') {
        if (availableCupChange($CompetitionEvent['Event_ID'])) {
            IncludeClass::Page('CompetitionEvent.PsychSheet');
        } else {
            IncludeClass::Page('CompetitionEvent.ResultsCup');
        }
    } else {
        if ($attempts_exists) {
            IncludeClass::Page('CompetitionEvent.Results');
        } else {
            IncludeClass::Page('CompetitionEvent.PsychSheet');
        }
    }
