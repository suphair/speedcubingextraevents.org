...
Function DataBaseInit(){
   ...
   DataBaseClass::AddTable('Discipline','D',array('ID','Name','Code','Status','Competitors','TNoodle','TNoodles','TNoodlesMult','CutScrambles','GlueScrambles','Simple','Inspection','CodeScript','Comment'));
